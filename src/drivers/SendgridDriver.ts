...
export class SendgridDriver implements Mailer {
    ...
    sendSingleTemplate(to: string | string[], from: string, subject: string, templateType: MAIL_DEFAULTS.TEMPLATES, templateVars: {}, text?: string, html?: string, cc?: string | string[], bcc?: string | string[], replyTo?: string, headers?: {}): Promise<any> {
        let email = {
            to: to,
            from: from,
            subject: subject,
    ...
    sendMultipleTemplate(to: string[], from: string, subject: string, templateType: MAIL_DEFAULTS.TEMPLATES, templateVars: {}[], text?: string, html?: string, cc?: string | string[], bcc?: string | string[], replyTo?: string, headers?: {}): Promise<any> {
